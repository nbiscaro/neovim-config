...
function M.setup()
    ...
    -- Diffview toggle keybindings with new prefix
    keymap("n", "<leader>md", "<cmd>lua toggle_diffview()<CR>", opts)
    keymap("n", "<leader>mf", "<cmd>lua toggle_file_history()<CR>", opts)
    keymap("n", "<leader>mr", "<cmd>lua toggle_repo_history()<CR>", opts)

    -- Additional Diffview commands (these don't need toggles as they're one-time actions)
    keymap("n", "<leader>mo", ":DiffviewOpen ", opts)  -- For specific branch/commit comparison
    keymap("n", "<leader>mF", ":DiffviewFocusFiles<CR>", opts)  -- Focus files panel
    keymap("n", "<leader>mR", ":DiffviewRefresh<CR>", opts)  -- Refresh view
end
